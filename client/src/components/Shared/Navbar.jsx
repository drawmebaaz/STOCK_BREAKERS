      ...
      <div className="flex h-full items-center justify-between gap-3 md:gap-4">
        <div className="flex min-w-0 items-center gap-3 md:gap-4">
          <button
            type="button"
            onClick={onMenuClick}
            className="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-md border border-slate-800 bg-[#101821] text-slate-300 transition-colors hover:border-slate-600 hover:text-white xl:hidden"
          ...
          <div className="hidden min-w-0 sm:block">
            ...
            <p className="mt-0.5 hidden text-xs text-slate-500 sm:block">
              {marketStatus?.status || "Market"} | Updated: {updatedLabel}
            </p>
          </div>
        </div>

        <div className="flex items-center gap-2 md:gap-3">
          <div className="hidden rounded-md border border-slate-800 bg-[#101821] px-3 py-2 text-right md:block">
          ...
          <div className="hidden rounded-md border border-slate-800 bg-[#101821] px-3 py-2 lg:block">
          ...
          <button
            onClick={logout}
            className="inline-flex h-10 items-center justify-center rounded-md border border-slate-800 bg-[#101821] px-2 text-[11px] font-semibold text-slate-400 transition-colors hover:border-slate-600 hover:text-slate-200 sm:px-3 sm:text-xs"
            title="Sign out"
            aria-label="Sign out"
          >
            Sign out
